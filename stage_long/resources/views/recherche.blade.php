...
@section('content')
    ...
    <div class="container" style="padding-top:60px;">
        ...
        <h4>Début du séjour: {{$data->debut}} - Fin du séjour: {{$data->fin}}</h4>
        ...
        <div class="text-right">
            ...
            <a href="{{action('HomeController@destroy',$data->id)}}" class="btn btn-danger"
               data-method="delete"
            ...
            @else
                ...
                {{Form::open(['action' => ['reservationController@update', $data->id], 'method' => 'put'])}}
